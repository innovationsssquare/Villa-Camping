...
export function getRecentlyVisited() {
  ...
  try {
    ...
    // Strictly filter out any unapproved or inactive properties that might have been cached earlier
...
export function saveRecentlyVisited(property, categoryName = "") {
  ...
  // NEVER save unapproved or non-live property to recently visited
