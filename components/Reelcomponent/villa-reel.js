            ...
            >
              ...
              <div className="relative p-3 space-y-2">
                ...
                <div className="flex items-center gap-2 text-white/90">
                  ...
                  <Button
                    onClick={() => {
                      const type = PROPERTY_ROUTE_MAP[villa.propertyType];
                      if (!type) return;

                      router.push(`/view-${type}/${villa.id}`);
                    }}
                    ...
                    <div className="flex items-center gap-2">
                      {villa.amenities.slice(0, 3).map((amenity, idx) => (
                        <div key={idx} className="flex items-center gap-1">
                          ...
                          {amenity === "Parking" && (
                            <Car className="w-3 h-3 text-white/70" />
                          )}
                          {amenity === "Pool" && (
                            <Coffee className="w-3 h-3 text-white/70" />
                          )}
                          {amenity === "Fireplace" && (
                            <Coffee className="w-3 h-3 text-white/70" />
                          )}
