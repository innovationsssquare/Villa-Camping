...
export function BookingSearchBox() {
  ...
  return (
    <div
      ...
      className="bg-[#FFFFFF4D] rounded-full border border-gray-300 shadow-sm p-1 flex justify-center items-center"
    >
      {/* Check-in */}
      <div className="flex-1 justify-center items-center px-4 py-2">
      ...
      {/* Search Button */}
      <Button onClick={handleSearch} size="icon" className="rounded-full bg-black hover:bg-[#0d5a6e] h-10 w-10 ml-2">
