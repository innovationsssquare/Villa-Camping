...
const CottageDetailsDrawer = ({ tent, open, onOpenChange, onBookNow }) => {
  const [currentImageIndex, setCurrentImageIndex] = React.useState(0);

  if (!tent) return null;

  const images = tent.cottageimages || [];
          ...
          <div className="px-4 pb-2 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="bg-muted/50 rounded-lg p-3 text-center">
                ...
                <p className="text-xs text-muted-foreground">Total Cottages</p>
...
export default CottageDetailsDrawer;
