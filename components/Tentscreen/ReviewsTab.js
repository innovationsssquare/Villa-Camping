                  ...
                  {mockReviews.map((review) => (
                    <div key={review.id} className="bg-villa-grey/30 p-4 rounded-lg">
                      <div className="flex items-start space-x-3">
                        <div className="w-10 h-10 bg-villa-orange rounded-full flex items-center justify-center text-white font-medium">
                          {review.initials}
                        </div>
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-1">
                            ...
                            {review.isTopReview && (
                              <span className="text-xs bg-villa-green text-white px-2 py-1 rounded-full">Top Review</span>
                            )}
                          </div>
                          ...
                          <div className="flex flex-wrap gap-2 mb-3">
                            {review.categories.map((category) => (
                              <span key={category} className="px-2 py-1 bg-villa-green/20 text-villa-green rounded text-xs">
                                ✓ {category}
                              </span>
                            ))}
                          </div>
