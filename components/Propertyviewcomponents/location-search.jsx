        ...
        {searchTerm === "" && (
          <>
            <div className={isMobile ? "mt-4" : "mt-4 md:mt-6"}>
              <h4
                className={`font-medium text-gray-900 mb-2 md:mb-3 ${isMobile ? "text-sm" : "text-sm md:text-base"}`}
                style={{
                  fontFamily:
                    'Airbnb Cereal VF, Circular, -apple-system, BlinkMacSystemFont, Roboto, "Helvetica Neue", sans-serif',
                }}
              ...
              {recentSearches.map((location, index) => (
                ...
                >
                  ...
                  <span
                    className={`text-gray-700 ${isMobile ? "text-sm" : "text-sm md:text-base"}`}
                    style={{
                      fontFamily:
                        'Airbnb Cereal VF, Circular, -apple-system, BlinkMacSystemFont, Roboto, "Helvetica Neue", sans-serif',
                    }}
              ...
              {popularDestinations.map((destination, index) => (
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div
                      className={`text-gray-500 ${isMobile ? "text-xs" : "text-xs md:text-sm"}`}
                      style={{
                        fontFamily:
                          'Airbnb Cereal VF, Circular, -apple-system, BlinkMacSystemFont, Roboto, "Helvetica Neue", sans-serif',
                      }}
        ...
        {searchTerm !== "" && (
          <div className={isMobile ? "mt-3" : "mt-3 md:mt-4"}>
            ...
            {filteredDestinations.length === 0 && (
              <div
                className={`text-gray-500 text-center py-4 ${isMobile ? "text-sm" : "text-sm md:text-base"}`}
                style={{
                  fontFamily:
                    'Airbnb Cereal VF, Circular, -apple-system, BlinkMacSystemFont, Roboto, "Helvetica Neue", sans-serif',
                }}
