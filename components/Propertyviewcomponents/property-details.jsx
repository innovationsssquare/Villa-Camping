...
import { Heart, Share, Star, MapPin, Users, Bed, Bath, Wifi, Car, Waves, Coffee, Plus, Minus } from "lucide-react"
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "March 2024",
      comment: "Absolutely stunning property with breathtaking views. The infinity pool is incredible!",
    },
    {
      name: "Michael Chen",
      rating: 5,
      date: "February 2024",
      comment: "Perfect for a luxury getaway. Every detail was thoughtfully designed.",
    },
  ]
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-red-500 font-bold text-xl">StayVista</span>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Gardenéa</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="border-b border-gray-200 pb-8">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Entire villa hosted by StayVista</h2>
            ...
            <div className="border-b border-gray-200 pb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Escape to luxury at Gardenéa, a stunning contemporary villa nestled in the serene landscapes of Alibaug.
                This architectural masterpiece features floor-to-ceiling windows, an infinity pool, and breathtaking
                views of the surrounding gardens. Perfect for families and groups seeking an unforgettable getaway with
