              ...
              {[1, 2, 3].map((item) => (
                <Card key={item} className="overflow-hidden">
                  <div className="relative">
                    <img
                      src={`/villa-sign.png?height=200&width=300&text=Hotel+${item}`}
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-medium">Hotel Paradise {item}</span>
                    </div>
                    <p className="text-sm text-gray-600 mb-2">Goa, India</p>
                    <p className="font-semibold">₹{12000 + item * 3000} night</p>
                  </CardContent>
                </Card>
              ))}
            </div>
