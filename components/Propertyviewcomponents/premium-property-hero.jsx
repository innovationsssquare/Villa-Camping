      ...
      <div className="w-full mx-auto px-4 sm:px-2 lg:px-4 py-4">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 h-[40vh]">
          ...
          <div className="lg:col-span-3 relative rounded-2xl overflow-hidden group">
            ...
            <div className="absolute bottom-6 left-6 flex space-x-4">
              <Button className="bg-black/70 hover:bg-black/80 text-white backdrop-blur-sm border-0 rounded-full px-6 py-3 font-medium">
        ...
        <div className="mt-8">
          <div className="flex items-start justify-between">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Gardenéa Villa in Alibaug</h1>
              <p className="text-lg text-gray-600">Luxury villa with infinity pool and stunning architecture</p>
            </div>
