      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/98 backdrop-blur-md border-t border-gray-200/90 px-4 pt-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] z-40 shadow-[0_-4px_16px_rgba(0,0,0,0.08)]">
        <div className="flex items-center justify-between gap-3 max-w-md mx-auto">
          ...
          <button
            ...
            className="bg-gradient-to-r from-[#ff6900] to-[#e05d00] hover:from-[#e05d00] hover:to-[#c55000] text-white px-5 sm:px-6 py-2.5 rounded-xl font-bold text-sm sm:text-base whitespace-nowrap shadow-md shadow-orange-500/25 active:scale-[0.97] transition-transform duration-100 cursor-pointer inline-flex items-center justify-center shrink-0 h-11 sm:h-12 touch-manipulation select-none"
          >
            Select Dates
          </button>
        </div>
