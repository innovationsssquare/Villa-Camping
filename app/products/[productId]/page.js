...
import Productdetails from "@/public/Homeasset/Productdetails.png"
import Aboutusheader from "@/components/Aboutuscomponets/Aboutusheader"

export default function ProductDetail() {
  return (
    <>
      <Aboutusheader image1={Productdetails} image2={Productdetails} title={"Product Details"}/>
    <div className="w-full md:px-8 px-3 mx-auto md:pt-8 pt-20 bg-white">
      {/* Navigation */}
      <div className="md:flex justify-between items-center mb-6 hidden ">
        <a href="#" className="flex items-center text-sm font-semibold text-gray-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="relative">
          <div className=" overflow-hidden ">
            <Image
              ...
              width={100}
              height={100}
              className="w-full object-cover h-[400px] md:rounded-3xl"
            />
          </div>
        ...
        {/* Product Info */}
        <div>
          <div className="inline-block px-2 py-1 bg-[#106C83] text-white text-xs font-medium rounded">
            Product Category
          </div>

          <h1 className="text-2xl font-bold mt-2">Product Name</h1>
          <p className="text-[#106C83]">Seller Name</p>
          ...
          {/* Product Details */}
          <div className="mt-6 bg-[#E8F2F4] p-4 rounded-md">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              <span className="px-3 py-1 bg-[#E8F2F4] text-gray-800 text-sm rounded-full">
                12 built-in stitch patterns
              </span>
              <span className="px-3 py-1 bg-[#E8F2F4] text-gray-800 text-sm rounded-full">Compact & easy to use</span>
              <span className="px-3 py-1 bg-[#E8F2F4] text-gray-800 text-sm rounded-full">
          ...
          <div className="mt-6">
            ...
            <div className="flex gap-2 mt-2">
              <button className="px-4 py-2 bg-[#106C83] text-white text-sm rounded-md">Small - 5 KG</button>
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center mt-2">
              ...
              <button className="ml-4 px-6 py-2 w-full bg-white border border-[#106C83] text-[#106C83] font-medium rounded-md">
                Add to Bag
              </button>
            </div>
          </div>
      ...
      <div className="mt-12">
        <Tabs defaultValue="description">
          <TabsList className="border-b border-gray-200 w-full justify-start">
            <TabsTrigger
              value="description"
              className="px-6 py-2 rounded-none text-gray-800 font-medium data-[state=active]:border-b-2 data-[state=active]:border-[#EDC5C5]"
            >
              Description
            </TabsTrigger>
            <TabsTrigger
              value="reviews"
              className="px-6 py-2 rounded-none text-gray-500 font-medium data-[state=active]:border-b-2 data-[state=active]:border-[#EDC5C5]"
            >
              Reviews
            </TabsTrigger>
          </TabsList>
